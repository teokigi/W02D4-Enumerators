...
class TestStarSystem < Minitest::Test
  ...
  def test_001_has_name
    assert_equal("Solar System", @solar_system.name)
  end

  def test_002_has_planets
    assert_equal(9, @solar_system.total_planets)
  end

  def test_003_planet_names
  ...
  def test_009_number_of_planets_less_than_1billion_km_from_sun
  ...
  def test_010_total_number_of_moons
    result = @solar_system.get_total_number_of_moons
    assert_equal(176, result)
  end

  def test_011_planet_names_sorted_by_increasing_distance_from_sun
  ...
  def test_012_planet_names_sorted_by_size_decreasing
